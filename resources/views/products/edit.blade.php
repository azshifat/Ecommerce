<!-- form start -->
<h2>Edit Product</h2>
<form id="EditForm" action="{{ route('product.update', $data->id) }}" method="POST" enctype="multipart/form-data">
    @csrf
    @method('POST')
    ...
    <div class="form-input-group">
        ...
        <textarea name="description" class="form-input" id="description">{{ $data->description }}</textarea>
    ...
    <div class="form-input-group">
        ...
        <input type="text" name="old_price" class="form-input" id="old_price" value="{{ $data->old_price }}">
    ...
    <div class="form-input-group">
        ...
        <input type="text" name="new_price" class="form-input" id="new_price" value="{{ $data->new_price }}">
    ...
    <div class="form-input-group">
        ...
        <img src="{{ $data->image ? '/storage/'.$data->image : '/images/male.png' }}" alt="Selected Image" id="previewImage" style="width:150px; height:150px;">
